...
/***/ "./resources/js/franco/components/alert.js":
/*!*************************************************!*\
  !*** ./resources/js/franco/components/alert.js ***!
  \*************************************************/
 ...
 *        }
 */
f_alert.generate = function (_ref) {
  var _ref$containerId = _ref.containerId,
    containerId = _ref$containerId === void 0 ? "" : _ref$containerId,
    _ref$type = _ref.type,
  ...
  var mainContainer = containerId != "" ? document.getElementById(containerId) : null;
  if (!mainContainer) {
    ...
    mainContainer = _document$getElements2[0];
  }
  var alertContainer = mainContainer.querySelector("div.f_alert-container");
  if (!alertContainer) {
  ...
  alert.setAttribute("class", "f_alert ".concat(type));
 ...
 *        }
 */
f_alert.convert = function (_ref2) {
  var _ref2$containerId = _ref2.containerId,
    containerId = _ref2$containerId === void 0 ? "" : _ref2$containerId,
    _ref2$type = _ref2.type,
    type = _ref2$type === void 0 ? "" : _ref2$type,
    _ref2$alertId = _ref2.alertId,
    alertId = _ref2$alertId === void 0 ? "" : _ref2$alertId,
    _ref2$autoremove = _ref2.autoremove,
    autoremove = _ref2$autoremove === void 0 ? true : _ref2$autoremove;
  var alertOld = alertId != "" ? document.getElementById(alertId) : null;
  var alertNew = null;
  if (alertOld) {
    ...
    if (!mainContainer) {
      ...
      mainContainer = _document$getElements4[0];
    }
    var alertContainer = mainContainer.querySelector("div.f_alert-container");
    if (!alertContainer) {
      alertContainer = document.createElement("div");
    ...
    // Agregando clase a la alerta
    if (type != "") {
      alertNew.setAttribute("class", "f_alert ".concat(type));
    }

    // Agregando boton close a la alerta
    var buttonClose = alertNew.querySelector("f_alert__close");
    if (!buttonClose) {
    ...
    if (autoremove === true) {
      setTimeout(function () {
        if (alertContainer.contains(alertNew)) {
          alertContainer.removeChild(alertNew);
        }
      }, 8000);
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f_alert);

/***/ }),

/***/ "./resources/js/franco/components/image.js":
/*!*************************************************!*\
  !*** ./resources/js/franco/components/image.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 *        }
 */
f_image.show = function (_ref) {
  var _ref$idInput = _ref.idInput,
    idInput = _ref$idInput === void 0 ? "" : _ref$idInput,
    _ref$idImg = _ref.idImg,
    idImg = _ref$idImg === void 0 ? "" : _ref$idImg;
  var file = idInput !== "" ? document.getElementById(idInput) : null;
  var image = idImg !== "" ? document.getElementById(idImg) : null;
  if (file || image) {
    ...
    console.error("InputFile o etiqueta de imagen no encontrados");
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f_image);

/***/ }),

/***/ "./resources/js/franco/components/menu.js":
/*!************************************************!*\
  !*** ./resources/js/franco/components/menu.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f_navegation);

/***/ }),

/***/ "./resources/js/franco/components/modal.js":
/*!*************************************************!*\
  !*** ./resources/js/franco/components/modal.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
*         }
 */
f_modal.generate = function (_ref) {
  var _ref$btnShow = _ref.btnShow,
    btnShow = _ref$btnShow === void 0 ? "" : _ref$btnShow,
    _ref$modal = _ref.modal,
    modal = _ref$modal === void 0 ? "" : _ref$modal,
    _ref$backdrop = _ref.backdrop,
    backdrop = _ref$backdrop === void 0 ? "" : _ref$backdrop;
  btnShow = document.getElementById(btnShow);
  modal = document.getElementById(modal);
  var buttonsClose = null;
  if (modal) {
    ...
    if (btnShow) {
      ...
      console.log("Boton mostrar modal no encontrado");
    }
  } else {
    console.error("Modal no encontrado");
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f_modal);

/***/ }),

/***/ "./resources/js/franco/components/table.js":
/*!*************************************************!*\
  !*** ./resources/js/franco/components/table.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 *        }
 */
f_table.resizable = function () {
  var idTable = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var pressed = false;
  var start = undefined;
  var startX, startWidth;
  var aggregatedMoveUp = false;
  var table = idTable !== "" ? document.getElementById(idTable) : null;
  if (table) {
    var addEventsMoveUp = function addEventsMoveUp() {
      if (!aggregatedMoveUp) {
    ...
    var assingWhidth = function assingWhidth(e) {
      if (pressed) {
    ...
    var removeEventsMoveUp = function removeEventsMoveUp() {
      window.removeEventListener("mousemove", assingWhidth);
      window.removeEventListener("mouseup", restore);
    };
    var headers = table.querySelectorAll("th");
    [].map.call(headers, function (th) {
      return th.addEventListener("mousedown", function (e) {
        start = this;
        pressed = true;
        startX = e.pageX;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f_table);
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _franco_components_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./franco/components/menu */ "./resources/js/franco/components/menu.js");
/* harmony import */ var _franco_components_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./franco/components/modal */ "./resources/js/franco/components/modal.js");
/* harmony import */ var _franco_components_alert__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./franco/components/alert */ "./resources/js/franco/components/alert.js");
/* harmony import */ var _franco_components_table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./franco/components/table */ "./resources/js/franco/components/table.js");
/* harmony import */ var _franco_components_image__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./franco/components/image */ "./resources/js/franco/components/image.js");
 ...
 */
(function (window) {
  var _init = function _init(containerId, menuId, toggleButtonId) {
    _franco_components_menu__WEBPACK_IMPORTED_MODULE_0__["default"].menu(containerId, menuId, toggleButtonId);
  };
  window.f_menu = {
    init: _init
  };
...
(function (window) {
  var _init = function _init(params) {
    _franco_components_modal__WEBPACK_IMPORTED_MODULE_1__["default"].generate(params);
  };
  window.f_modal = {
    init: _init
  };
 ...
 */
(function (window) {
  var _generate = function _generate(params) {
    _franco_components_alert__WEBPACK_IMPORTED_MODULE_2__["default"].generate(params);
  };
  var _convert = function _convert(params) {
    _franco_components_alert__WEBPACK_IMPORTED_MODULE_2__["default"].convert(params);
  };
  window.f_alert = {
    generate: _generate,
    convert: _convert
 ...
 */
(function (window) {
  var _show = function _show(params) {
    _franco_components_image__WEBPACK_IMPORTED_MODULE_4__["default"].show(params);
  };
  window.f_image = {
    show: _show
  };
...
(function (window) {
  ...
  _franco_components_menu__WEBPACK_IMPORTED_MODULE_0__["default"].menu("menuModules", "menuModules", "btnToggleMenuModules");
  _franco_components_menu__WEBPACK_IMPORTED_MODULE_0__["default"].menu("menuHeader", "menuHeader", "btnToggleMenuHeader");
 ...
 */
(function (window) {
  var _resizable = function _resizable(idTable) {
    _franco_components_table__WEBPACK_IMPORTED_MODULE_3__["default"].resizable(idTable);
  };
  window.f_table = {
 ...
 */
(function (window) {
  var _cleanForm = function _cleanForm(_ref) {
    var _ref$idForm = _ref.idForm,
      idForm = _ref$idForm === void 0 ? "" : _ref$idForm,
      _ref$hidden = _ref.hidden,
      hidden = _ref$hidden === void 0 ? false : _ref$hidden;
    var oForm = idForm != "" ? document.getElementById(idForm) : null;
    if (oForm) {
      oForm.reset();
 ...
 */
(function (window) {
  var _formPreventSendWithEnter = function _formPreventSendWithEnter(idForm) {
    var oForm = idForm != "" ? document.getElementById(idForm) : null;
    if (oForm) {
